...
namespace Populous
{
    ...
    public readonly struct TerrainTile : IEquatable<TerrainTile>
    {
        ...
        public readonly bool IsOccupied() => StructureManager.Instance.IsTileOccupied(this);
        ...
        public readonly Vector3 GetCenterPosition() => new(
            m_X + Terrain.Instance.UnitsPerTileSide / 2, 
            GetCenterHeight(),
            m_Z + Terrain.Instance.UnitsPerTileSide / 2
        );
        ...
        public readonly TerrainPoint GetClosestCorner(TerrainPoint point)
        {
            ...
            foreach (TerrainPoint corner in GetCorners())
            {
                float d = Vector3.Distance(point.ToWorldPosition(), corner.ToWorldPosition());
