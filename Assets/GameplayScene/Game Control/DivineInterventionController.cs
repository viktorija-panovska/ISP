...
namespace Populous
{
    ...
    public class DivineInterventionController : NetworkBehaviour
    {
        ...
        private void Start()
        {
            ...
            SetManna(Faction.RED, m_ActivationThreshold[(int)DivineIntervention.ARMAGEDDON]);
            SetManna(Faction.BLUE, m_ActivationThreshold[(int)DivineIntervention.ARMAGEDDON]);
        }
